...
namespace World
{
	...
	{
		/// <summary>
		/// The <see cref="PressureLookup"/> contains two functions, AirPressure & WaterPressure that will return the water pressure for any given depth (in meters from surface, absolute float) or air pressure in meters from ground level.
		/// </summary>
        ///
